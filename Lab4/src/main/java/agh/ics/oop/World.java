...
public class World {
    public static void main(String[] args){
        ...
        String[] objects = {"12221_Cat_v1_l3","LOW_POLY_piece_Knight_FINAL1","10042_Sea_Turtle_V2_iterations-2","12268_banjofrog_v1_L3"};
        String[] textures = {"res/Cat_diffuse.jpg","res/horse_texture.png","res/10042_Sea_Turtle_V1_Diffuse.jpg","res/12268_banjofrog_diffuse.jpg"};
