...
public class Animal extends Entity implements IMapElement{
    ...
    public void move(MoveDirection direction){
        ...
        if (map.canMoveTo(newPosition)){
            observersPositionChanged(positionOnPlane, newPosition);
            Game.animationController.makeAnimation(this,dest,rot,1);
    ...
    void observersPositionChanged(Vector2d oldPosition, Vector2d newPosition){
    ...
    public String getDesc(){
        return "Z " + positionOnPlane.toString();
    }
}
